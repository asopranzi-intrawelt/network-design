...
- [x] `Aruba (amministrazione e cloud)/` — 6 file → verificato 09/07/2026: notifiche automatiche top-up Aruba Cloud + un documento di studio (23/12/2025) sull'acquisto di un VPS Aruba Cloud (piano O4A8, 4 vCPU/8GB/80GB, promo 5,89€/mese), mai confermato come completato nella fonte. Il documento contiene numerose credenziali reali (password di reset, codici di accesso) MAI riportate. Nessuna ingestione in file tracciato
