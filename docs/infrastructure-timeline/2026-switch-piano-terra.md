...
### Chiuso in giornata, e cio' che la chiusura non chiude
...
Restano due cose che il rinnovo non risponde, e che vanno tenute separate dal difetto chiuso per non trasformare una buona notizia in un'affermazione piu' larga di quello che si sa. Il **cambio di regione** decide dove sia la storia depositata fino a luglio: se lo spazio di Milano e' nuovo nasce vuoto, e la copia fuori sede dei dati storici torna a esistere solo quando il primo caricamento completo e' finito; se e' il precedente migrato non manca niente. E resta non determinato se questo percorso e la replica verso lo spazio a blocchi descritta nella scheda di continuita' siano **due copie distinte o la stessa descritta due volte**, che e' una domanda su quante copie esistano e non su questa.
