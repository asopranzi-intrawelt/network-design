...
## 06/08/2026 - Il livello elettrico entra nella documentazione, e il parco telefonico digitale non c'e' piu'

Tre file passati a mano dall'IT Manager chiudono in una sola sessione due lacune che il progetto dichiarava aperte da mesi. Il documento `STATO RETE INTRAWELT.docx`, comparso nel delta della stessa mattina sotto `Cybersec & IT Governance` e scritto dall'IT Manager, descrive per la prima volta l'alimentazione dei due armadi del Piano 2 e la mappa completa fra porte degli switch e apparati; la scheda dei telefoni prodotta dal progetto il 05/08 torna compilata con modelli, prese e ubicazioni dei cinque Yealink, con l'identificazione dell'apparato sulla porta 3 del 30HP e con l'etichetta reale dell'adattatore analogico dell'ascensore. Ne nasce la scheda `docs/livello-fisico-ed-elettrico.md` con la sua controparte non anonimizzata in `_notes/`, secondo la regola dei due layer, e ne nascono sei difetti nuovi. Il terzo file, l'estratto tematico del 03/08, torna invariato e serve solo da confronto.

### L'alimentazione: tre gruppi di continuita', e quattro cose che non vanno

I gruppi d'armadio sono tre, tutti al Piano 2: un APC Smart-UPS SC 1500 e un APC Back-UPS ES 400 nel rack di sinistra, un Elsist UPServer 4.0 online a doppia conversione nel rack di destra. Il quarto, quello di Sala-1 che alimenta l'iniettore PoE dell'antenna, era gia' noto per sentito dire e resta senza modello.

Quattro difetti escono dalla stessa lettura. Nessuno dei tre gruppi ha una scheda di rete, quindi nessun allarme di alimentazione raggiunge nessuno e la prima notizia di un guasto e' l'apparato che si spegne (ELE-001, #145). Il firewall e' alimentato in fondo a tre ciabatte in cascata, quattro connessioni elettriche in serie per l'apparato attraverso cui passa tutto il traffico verso Internet, con il carico complessivo mai misurato (ELE-002, #146). Il NAS-HERO ha i due alimentatori sotto lo stesso gruppo, quindi ha la ridondanza dell'alimentatore e non quella della sorgente, e del server HP Gen10 risulta alimentato il solo PS2 (ELE-003, #147). E lo switch del Piano Terra non compare sotto nessun gruppo, il che significa che al primo black-out cadono i due telefoni del piano, la reception, l'access point, il timbracartellini e la tratta che esce verso l'esterno (ELE-004, #148).

Quest'ultimo difetto e' anche una risposta: la domanda "cosa deve alimentare l'UPS rack Addpower del preventivo del 31/07" aveva bloccato M13c-6 perche' il progetto non conosceva i carichi. Ora si sa, ed e' lo switch prima di ogni altra cosa.

### Il centralino Panasonic e i ventisette apparecchi digitali sono stati rimossi il 31/07

E' il fatto che cambia il piano della fonia. TEL-003 era stato aperto il 03/08 come "ventisette apparecchi digitali da migrare, e per ciascuno va scelto fra telefono SIP, softphone o gateway". La scelta non e' piu' davanti a una migrazione: gli apparecchi non ci sono piu' dal 31/07, e il centralino cloud che deve sostituirli non e' attivo perche' la quantita' di interni del contratto e' ancora in bianco e i messaggi non sono decisi. Ventisette postazioni sono quindi senza terminale per un tempo indeterminato, e con che cosa telefonino oggi non e' deducibile da nessuna fonte di questo progetto: e' la prima domanda da porre. Tracciato come TEL-004 (#150), con due code, la sorte del Patton SmartNode 5551 che non ha piu' un centralino dietro e lo smaltimento degli apparecchi rimossi.

### Tre identificazioni, e una correzione che rovescia un'ipotesi

L'apparato sulla porta 3 del 30HP, che NET-020 registrava tre giorni prima come sconosciuto, e' l'unita' master del sistema di rilevazione presenze Suprema: coerente con la presa 0-10-1 del rilievo del 2020, coerente con il MAC che la mappa privata teneva dal 23/07 come non identificato. L'identificazione chiude la domanda e apre il problema, perche' e' un dispositivo IoT/OT su LAN piatta, assente da ogni inventario, su una porta che accetta qualunque VLAN taggata, e tratta dati di presenza dei dipendenti (NET-021, #149).

L'adattatore analogico dell'ascensore non e' in attesa di installazione: e' installato sulla porta 6 del 54HP, con uscita verso la presa 2.8.1, ed e' un HT812 e non l'HT802 dell'offerta firmata a marzo. La corroborazione e' indipendente dalla dichiarazione, perche' il MAC appreso su quella porta e' l'indirizzo immediatamente successivo a quello di etichetta, che e' il comportamento normale di un apparato con due interfacce. Ne segue che la disattivazione del NAT interno passa da precauzione condizionale a requisito.

La correzione riguarda i telefoni, e vale come metodo. Il progetto portava dal 09/06 una contraddizione fra uno screenshot che etichettava la porta 3 del 54HP come "SIP-T34W Persona-A" e un rilievo di maggio che collocava i tre T34W al Piano Terra, e aveva concluso che l'etichetta fosse sbagliata. Era il contrario: l'etichetta era giusta, il rilievo sbagliato, e i modelli sono due T34W e tre T31G invece di tre e due. E' la seconda smentita dello stesso rilievo in tre giorni, dopo quella sulla distribuzione fra i piani, e conferma la regola del protocollo delle fonti secondo cui un rilievo e' una fotografia datata e non uno stato.
...
## 24/08/2026 - Il livello di virtualizzazione entra nella mappa, e con esso quattro difetti che nessuno aveva scritto

Fino a questa data il progetto descriveva il server come un apparato solo: un riquadro con dentro dieci macchine. La mappa interattiva ha ricevuto il livello di virtualizzazione, cioe' i quattro bridge Linux dell'host e le macchine attestate su ciascuno, letti dall'API Proxmox in sola lettura, piu' la matrice completa delle porte dei due switch gestiti estratta dallo snapshot Nebula. Il progetto conosceva ventisei porte su ottantaquattro, e solo come etichetta di collegamento.

Ne sono usciti quattro difetti, e la ratio per cui contano e' la stessa per tutti e quattro: erano affermazioni corrette diventate false, oppure fatti mai messi per iscritto, non contraddizioni che qualcuno avesse potuto notare leggendo. Il #152 registra che i quattro bridge hanno l'aspetto di una segregazione e non lo sono, perche' nessuno e' VLAN-aware, nessuna macchina porta un tag e i quattro cavi terminano nello stesso dominio di broadcast. Il #153 registra che la corrispondenza fra i nomi delle schede nel sistema operativo, le prese sul telaio e le porte dello switch non era mai stata confrontata, ed era il prerequisito bloccante del micro-step M4. Il #156 registra otto porte che negoziano a 10 Mb/s su hardware gigabit e vedono zero indirizzi. Il #157, il piu' pesante, registra che l'indirizzo con cui si amministra l'hypervisor attraversa lo switch QNAP non gestito, il che rende inapplicabile il piano DMZ scritto il 05/06/2026.

## 25/08/2026 - Il ramo del server spiegato per intero, e la porta 7 confermata dallo switch stesso

Giornata di documentazione e di misura, nata da una domanda dell'IT Manager sul modo in cui il server e' attaccato alla rete, e proseguita chiedendo conto di ogni termine usato nella risposta. L'esito documentale e' la scheda `docs/virtualizzazione-proxmox-e-bridge.md`, che tiene insieme il deep-dive tecnico e il fondamento didattico e che va letta insieme a questa voce.

### Perche' il censimento delle porte e il lavoro sui bridge sono due binari, e la correzione di sequenza

La prima proposta metteva in fila il censimento delle porte prima del lavoro sulla DMZ, con l'argomento di scendere in armadio una volta sola. L'IT Manager ha osservato che i due non hanno alcuna dipendenza reciproca, e aveva ragione: il binario dei bridge ha un solo prerequisito, la conferma su quale porta esca `vmbr1`, e il censimento delle postazioni non vi entra. La sequenza e' stata corretta e le due tracce procedono in parallelo. Vale come lezione di metodo: un ordine giustificato da un'economia di spostamenti non e' un ordine giustificato da una dipendenza tecnica, e i due non vanno confusi.

### Nove porte identificate senza scendere in armadio

Incrociando la tabella MAC dei due switch, che dice quale indirizzo fisico si vede su quale porta, con l'inventario delle interfacce di rete di NinjaOne, che dice a quale computer appartiene ciascun indirizzo, si attribuiscono nove porte fino a ieri anonime: la 25, la 26, la 32 e la 34 del 54HP, e la 5, la 8, la 10, la 16 e la 20 del 30HP. Nessuna delle due fonti sapeva da sola la cosa dell'altra. Lo snapshot dell'RMM e' stato rinfrescato lo stesso giorno prima dell'incrocio, perche' un indirizzo fisico cambia quando una postazione viene sostituita e un dato di ventisei giorni prima avrebbe potuto attribuire una porta al computer sbagliato. La corrispondenza con nomi host e indirizzi reali vive in `_notes/censimento-porte-2026-08-25.md`, non versionato.

Nella stessa verifica la scheda del livello fisico e la fonte della mappa sono state confrontate riga per riga: sul 54HP coincidono esattamente su diciannove porte, sul 30HP la scheda ne descrive tre in piu'. Non si contraddicono in nessun punto, hanno copertura diversa, ed e' una distinzione che vale la pena registrare perche' cambia il tipo di lavoro necessario.

### La conferma LLDP, e perche' installare un pacchetto e' stata la scelta giusta

Il micro-step M4-0, prerequisito nuovo introdotto in giornata, consiste nel far dire allo switch stesso su quale porta arrivi il cavo di `eno2`, invece di dedurlo dagli indirizzi che vi transitano. La ragione per cui non ci si poteva accontentare della deduzione e' che al passo successivo, M4, si prende una porta e la si trasforma da accesso a trunk: sbagliare porta avrebbe prodotto due danni insieme, la DMZ non funzionante e la configurazione alterata su un cavo che porta altro.

Sull'host `lldpd` non era installato. Fra aggirare il problema con una singola trama forzata e installare il pacchetto, si e' scelta la seconda, perche' costa uguale e il beneficio dura: da oggi tutte e quattro le schede del server si identificano da sole e l'ambiguita' fra le tre numerazioni non puo' piu' ripresentarsi. L'installazione ha portato quattro dipendenze di sistema e ha registrato il servizio all'avvio, senza toccare la configurazione di rete.

La risposta ha dato tre cose. Il numero di porta, `PortID: local 7`, che chiude il difetto #153 in tutte e quattro le righe e fa cadere il prerequisito bloccante di M4. L'identita' del vicino, che coincide con quanto la mappa gia' affermava e vale quindi come verifica indipendente della fonte. E due informazioni che nessuno cercava: l'indirizzo di gestione dello switch, che sta nella classe delle postazioni e non in un segmento di gestione, e la versione di firmware dichiarata, `V4.80(ABXQ.2)` dell'08/07/2023, da cui il difetto nuovo #158.

### I due vincoli posti dall'IT Manager, e cosa escludono

Primo, i collegamenti fisici del server non si spostano: il difetto #157 non si risolve ricablando, e la DMZ deve appoggiarsi a un bridge gia' su switch gestito con una modifica di sola configurazione. Secondo, nessun intervento deve togliere agli endpoint interni l'accesso ai servizi interni: segmentare significa rendere esplicito e filtrato cio' che oggi e' implicito e non filtrato, non interrompere. Da questo secondo vincolo discende che per un portale destinato a soli utenti interni la destinazione corretta e' la VLAN 50 dei servizi applicativi interni prevista da M22d, non la DMZ 201, che serve a cio' che si pubblica verso l'esterno.

Nello stesso scambio e' emerso che oggi la protezione dei servizi interni e' affidata al firewall di sistema delle singole macchine Linux, e che di quella configurazione il progetto non ha alcun censimento. E' il micro-step M27-7, ed e' un prerequisito e non un complemento: senza sapere che cosa ogni host permette oggi, una regola di rete rischia di togliere un accesso funzionante, che e' esattamente cio' che il secondo vincolo vieta.

## 28/08/2026 - Il censimento M27-7 rovescia una premessa: la difesa host-based non esiste

Il 25/08 l'IT Manager aveva indicato il firewall di sistema delle singole macchine Linux come il livello che oggi protegge i servizi interni, e su quella base era stato aperto il micro-step M27-7 con l'argomento che, prima di scrivere una regola di rete, bisogna sapere che cosa ciascun host permette, per non togliere un accesso funzionante. Il censimento ha misurato l'opposto di cio' che cercava: su sette macchine ispezionate `ufw` non e' installato su sei, e sulla settima e' installato e dichiara stato inattivo.

La ratio per cui questo conta piu' di un dettaglio di configurazione e' che cambia il ruolo del lavoro in corso. Cio' che oggi impedisce a un host qualunque della LAN piatta di raggiungere una qualunque porta in ascolto e' soltanto il fatto che nessuno ci prova, piu' l'autenticazione che ciascuna applicazione si porta dietro. Ne discende che il firewall di rete previsto dalla segmentazione non sara' un secondo strato di difesa ma il primo, e che il timore di rompere con una regola una configurazione host-based esistente non ha oggetto: non c'e' nulla da preservare a quel livello, c'e' tutto da costruire. Il vincolo dell'IT Manager sull'accesso interno resta valido e va rispettato, ma ora si applica con una matrice in mano invece che a memoria.

Otto difetti nuovi, dal #159 al #166. Il piu' grave e' il gestore delle password della VM 202, che risponde sulla porta 80 e non ha nessun ascolto sulla 443: il deposito delle credenziali aziendali viaggia in chiaro su una rete dove ogni apparato e' adiacente a ogni altro, e la password principale vi transita a ogni accesso. Il secondo e' PostgreSQL della VM 209, in ascolto su tutte le interfacce: non e' solo un'esposizione ma anche una contraddizione con cio' che il progetto affermava, cioe' che quel database vivesse sulla sola rete interna dei container, e la fonte della mappa e' stata corretta di conseguenza. Il terzo riguarda due macchine su cui non si entra piu' per credenziali perdute, la 205 e la 208, e pesa perche' la 208 e' il portale asset, cioe' proprio il servizio che la segmentazione deve spostare per primo: il micro-step M22d ha oggi un blocco che non e' di rete. Seguono gli ambienti di prova esposti accanto alla produzione su due macchine, la scrivania remota aperta a tutta la LAN sulla 810, una versione di Ubuntu probabilmente fuori supporto sulla 602 e quattro macchine che rispondono con lo stesso nome host.

Due cose vanno dette sul metodo, perche' la misura non e' completa e dichiararlo fa parte del risultato. La prima e' che su sei macchine su sette il comando e' stato eseguito da un utente non privilegiato: l'elenco delle porte in ascolto e' comunque completo e affidabile, perche' quel dato il kernel lo espone a chiunque, ma mancano il nome del processo che tiene aperta ciascuna porta e l'elenco dei container, e su tre macchine la risposta "nessun docker" e' un errore di permessi e non un'assenza, come dimostra la presenza delle reti interne del motore. La seconda e' che dove i container pubblicano porte il rimedio host-based non e' una regola di filtro, perche' il motore dei container inserisce regole valutate prima di quella catena: e' la pubblicazione stessa che va portata su loopback, il che e' una modifica di una riga e non richiede alcun filtro.

Matrice completa, spiegazione della differenza fra ascolto su tutte le interfacce e ascolto locale, e ricadute sul piano in `docs/esposizione-servizi-interni.md`.

## 31/08/2026 - La conclusione del censimento viene corretta: un filtro puo' vivere a quattro livelli, ne era stato guardato uno

La voce del 28/08 registrava che il censimento M27-7 aveva misurato l'assenza di `ufw` su tutte le macchine interne e ne concludeva che "la protezione dei servizi interni non e' affidata a nulla". L'IT Manager ha corretto la conclusione portando un controesempio puntuale: sulla VM 204, che ospita il convertitore dei ruolini, l'accesso e' ristretto per indirizzo e sono ammessi soltanto la sua postazione e due indirizzi della fascia `.70`. Quella restrizione esiste, funziona, e `ufw status` non la vede.

La ratio della correzione, che vale piu' del singolo caso. Fra il pacchetto che arriva sul cavo e la risposta dell'applicazione ci sono almeno quattro punti in cui qualcuno puo' aver deciso di negare l'accesso: il filtro di pacchetti del kernel, che `ufw` amministra ma che si scrive anche con `iptables` o `nftables` senza che `ufw` ne sappia nulla; il server web davanti all'applicazione, dove una restrizione per indirizzo si scrive con direttive di ammissione; l'applicazione stessa, che puo' controllare il chiamante nel proprio codice e non lascia traccia in nessun comando di sistema; e i contenitori, che inseriscono regole valutate prima di quelle di `ufw`. Il censimento ne aveva interrogato uno e aveva concluso sull'insieme, il che e' scambiare l'assenza di una prova per la prova di un'assenza. La forma della VM 204 e' peraltro coerente con il secondo livello: due processi Python in ascolto sul solo loopback e due porte pubbliche servite da quello che ha l'aspetto di un server web.

Il fatto che sopravvive alla correzione e' piu' stretto e piu' utile: il livello host-based **non e' governato in modo uniforme ne' ispezionabile centralmente**. Alcune macchine hanno restrizioni, altre no, nessuno sa quali senza leggerle una per una in posti diversi, e nulla segnala se una viene rimossa. Il difetto #159 e' stato riformulato in questi termini.

Ne discende una conseguenza sul piano di segmentazione **opposta** a quella scritta il 28/08, e piu' onerosa. Una lista di indirizzi ammessi si rompe quando gli indirizzi cambiano, e la segmentazione cambia gli indirizzi: se una delle postazioni ammesse sulla VM 204 finisse in un segmento diverso, il convertitore la rifiuterebbe, e lo farebbe in modo silenzioso, perche' il servizio continuerebbe a rispondere e l'errore somiglierebbe a un problema applicativo. La seconda passata del censimento non e' quindi una rifinitura ma un prerequisito di M22: le liste vanno trovate tutte prima di toccare gli indirizzi e aggiornate nello stesso intervento.

Aperto un difetto nuovo che nasce dal modo in cui la correzione e' arrivata, #167: le restrizioni esistenti non sono documentate da nessuna parte e si scoprono perche' qualcuno se le ricorda. Non e' un rilievo sulla restrizione, che e' una buona pratica: e' che una difesa nota a una sola persona non e' verificabile ne' trasferibile, e nessuno puo' oggi affermare quali altre macchine ne abbiano di simili.

Nella stessa sessione sono state definite tre cose che mancavano. Il comando della seconda passata, che interroga tutti e quattro i livelli invece di uno solo. Il censimento della **VM 100 WinServer2022**, finora fuori dal quadro perche' il comando era scritto per Linux: la macchina ha Windows Defender Firewall attivo per costruzione, quindi li' la domanda non e' se il filtro esista ma quali eccezioni siano state aperte, ed e' emerso il vincolo che quella macchina e' **l'unica attestata su `vmbr1`**, il bridge scelto per la VLAN 201, il che impone che M4 conservi la VLAN 1 non taggata sulla porta 7. E le due procedure per rientrare nelle VM 205 e 208, con la nota di sequenza che discende da #162 e #160: le password nuove vanno depositate dopo aver messo in sicurezza il deposito, non prima.

## 31/08/2026 (2) - Dismessa la VM 206, e messo in piedi il registro delle credenziali locali

Due fatti operativi nella stessa giornata in cui la conclusione del censimento veniva corretta.

### La VM 206 non esiste piu'

L'IT Manager ha spento e distrutto la VM 206 `intrasite` con `qm destroy 206 --purge`, dichiarando che per il momento non serve. Era la copia uno a uno del rifacimento del sito commissionato all'agenzia, tenuta come riferimento di contenuto e di marchio, e stava su `vmbr2` insieme alla VM 209.

Il presupposto e' stato verificato invece che riferito: sul NAS, sotto `Backup/dump`, esistono copie `vzdump-qemu-206` del 16/06, 26/07, 23/08, 29/08, 30/08 e **31/08/2026 alle 06:44**, ciascuna di circa venti gigabyte, ciascuna con il proprio file di annotazioni. La copia piu' recente e' dello stesso giorno, presa poche ore prima della dismissione. Il dettaglio vale la pena di essere scritto perche' e' cio' che distingue una dismissione da una perdita di dati, e perche' fra sei mesi nessuno ricordera' che il backup c'era.

Sull'opzione `--purge` una precisazione che serve alle prossime volte: senza di essa Proxmox rimuove la macchina ma lascia i riferimenti che le fanno gli altri oggetti della configurazione, in particolare i job di backup e le regole di replica, che continuano a puntare a una macchina inesistente e falliscono a ogni esecuzione. Con `--purge` quei riferimenti se ne vanno insieme ai dischi, il che rende l'operazione piu' pulita e insieme piu' definitiva: il ripristino non e' un annullamento ma un lavoro a se', perche' cio' che stava fuori dal disco va rifatto a mano.

Aggiornati nella stessa sessione tutti i luoghi in cui la macchina compariva: la fonte della mappa, che scende a cinquantacinque nodi e settantuno collegamenti, la matrice dell'esposizione, il diagramma sotto `.claude/context/diagrams/`, la scheda dei bridge e quella della segmentazione. E' il punto in cui una documentazione comincia a mentire senza che nessuno lo faccia apposta: basta toglierla da un posto solo.

### Il registro delle credenziali locali, e un difetto che non era stato visto

L'IT Manager ha verificato una per una le password locali delle macchine virtuali e ne manca **una sola**, quella dell'utente della VM 208. La verifica in se' chiude gran parte di #162, ma nel farla e' emerso il difetto piu' generale, tracciato come **#168**: quella risposta oggi si ottiene soltanto provando a entrare macchina per macchina, perche' non esiste da nessuna parte un registro di quali credenziali siano ancora note. Non e' lo stesso problema di #162, che riguarda due macchine specifiche: qui il punto e' che nessuno puo' sapere quante siano senza provarle tutte, quindi l'intervento di recupero non si puo' ne' dimensionare ne' dichiarare concluso.

Il rischio che ne discende e' asimmetrico, ed e' il motivo per cui il difetto merita un codice proprio. Finche' le macchine rispondono all'autenticazione con chiave dalla postazione dell'IT Manager tutto sembra funzionare; ma la password locale serve esattamente nei casi in cui la chiave non basta, cioe' l'accesso dalla console quando la rete della macchina non funziona, che e' lo scenario di guasto. Una credenziale che manca si scopre nel momento peggiore.

Lo strumento del censimento e' stato esteso di conseguenza: `scripts/Invoke-HostCensus.ps1` verifica prima che l'host risponda a chiave, cosi' da distinguere "non raggiungibile" da "password non accettata"; se `sudo` rifiuta la ripropone e poi offre di proseguire senza privilegi o di annotare l'host; e produce `output/password-da-recuperare.txt`, che e' il registro che mancava. Una correzione al volo sullo stesso strumento merita di essere registrata perche' e' un errore facile da rifare: nella prima versione l'output passava per `Tee-Object`, e siccome il prompt della password di `sudo` viaggia sullo pseudo-terminale allocato da `ssh -t`, finiva incanalato nella pipeline e non compariva a schermo, lasciando il comando in attesa di un input mai chiesto visibilmente.

Registrata anche la corrispondenza fra i tre nomi con cui la stessa macchina compare: il nome in Proxmox, il nome host interno e l'alias SSH della postazione, che ricorda l'applicazione invece della macchina — `odoo-vm` per il convertitore dei ruolini, `openproject-vm` per quello che Proxmox chiama GanttTool. La loro non coincidenza aveva gia' prodotto un fraintendimento in giornata, ed e' anche il modo in cui si e' recuperato l'indirizzo della VM 205, che il censimento non aveva rilevato.

## 31/08/2026 (3) - Una DMZ o due segmenti: la domanda che rimette in ordine il piano, e il censimento che la corrobora

Giornata in cui il lavoro sulla segmentazione ha guadagnato sia il criterio di progetto che gli mancava sia i primi dati misurati su cui applicarlo.

### La domanda dell'IT Manager, e l'equivoco di linguaggio che ha sciolto

La domanda era duplice: la DMZ non deve togliere i servizi interni agli endpoint della LAN, che devono continuare a raggiungerli; e forse allora serve un segmento distinto per i servizi che Intrawelt eroga verso l'esterno, come il portale asset.

La prima meta' ha smascherato un'ambiguita' nel modo in cui questa documentazione si era espressa fino a quel momento. "Togliere i servizi dalla LAN piatta" non significa renderli irraggiungibili: significa che il traffico fra una postazione e un servizio, che oggi passa da uno switch senza che nessuno lo esamini, dopo la segmentazione attraversa il firewall, che lo lascia passare se una regola lo prevede. La differenza non e' se il collegamento funziona, ma **chi ha deciso che funzioni**. Oggi funziona perche' non esiste nulla che lo impedisca, ed e' la stessa ragione per cui funzionerebbe un collegamento che nessuno vuole. Ne discende che il vincolo posto il 25/08 e' pienamente compatibile con la segmentazione, a una condizione operativa: le regole che permettono gli accessi legittimi vanno scritte contestualmente allo spostamento, non dopo.

La seconda meta' era gia' prevista dalla roadmap ma senza un criterio esplicito, e il criterio istintivo porta fuori strada. **Non e' chi usa il servizio a determinarne il segmento**, altrimenti tutto cio' che serve ai dipendenti starebbe dentro. E' **da dove puo' arrivare una connessione non richiesta**. Un servizio raggiungibile da Internet puo' ricevere connessioni da chiunque senza che nessuno lo sappia, quindi e' il candidato a cadere per primo e va nella DMZ, VLAN 201, il cui senso e' negare per impostazione predefinita la direzione DMZ verso LAN. Un servizio raggiungibile solo dall'interno va nella VLAN 50 dei servizi applicativi interni, gia' prevista da M22d, il cui senso non e' proteggersi da Internet ma impedire che una postazione compromessa raggiunga senza filtro ogni servizio, e simmetricamente che un servizio compromesso raggiunga ogni postazione e ogni NAS.

Il portale asset e' il caso che rende concreta la distinzione, e su cui la documentazione aveva detto due cose diverse in momenti diversi. Oggi serve utenti interni, quindi la destinazione corretta e' la VLAN 50; il piano di giugno lo destinava alla DMZ perche' allora si prevedeva di pubblicarlo, e non e' successo. Se un giorno verra' pubblicato non serviranno due copie ne' una seconda DMZ: si sposta nella VLAN 201 e si scrive una regola che consente alle postazioni di raggiungerlo, perche' **la DMZ nega la direzione DMZ verso LAN, non LAN verso DMZ**. E' l'asimmetria che rende utile il segmento, e capirla evita di duplicare i servizi.

Va detto anche cio' che la segmentazione non risolve: separa i segmenti, non le identita'. Se la stessa credenziale apre piu' macchine, spostarle in segmenti diversi riduce quante se ne raggiungono, non quante se ne aprono.

### Il censimento conferma l'ipotesi e ne rovescia un'altra

Cinque macchine interrogate su tutti e quattro i livelli. La restrizione della VM 204 sta dove era stato ipotizzato, cioe' nel server web: quattro direttive `allow` seguite da `deny all`, su due configurazioni di nginx, quella di esercizio e quella di collaudo. Sulle altre quattro macchine non esiste alcuna restrizione a nessun livello, con una sola eccezione parziale sulla VM 208, dove i servizi di appoggio sono correttamente pubblicati sul solo indirizzo locale mentre le porte del portale sono aperte a tutta la LAN.

Tre difetti nuovi. Il **#171** e' quello che tocca direttamente M22: gli indirizzi ammessi sono scritti come valori letterali dentro i file di configurazione, quindi la segmentazione li rompera' in silenzio, e il guasto somigliera' a un problema applicativo invece che a un intervento di rete. Il rimedio e' completare il censimento e riportare ogni lista nella matrice dei flussi, cosi' che lo spostamento di segmento e l'aggiornamento della lista siano lo stesso intervento e non due. Il **#172** nasce da un dato che nessuna scheda mostra da sola: nessun servizio SSH dichiara quali metodi di autenticazione accetti, quindi valgono i valori predefiniti che ammettono la password, e letto insieme a #159 e #170 e' una via di movimento laterale che non richiede di violare nulla.

Il terzo non e' nuovo ma finalmente circostanziato: di **#160** si conosce ora il meccanismo. Il contenitore del gestore delle password espone la porta solo verso l'interno della macchina, come dev'essere, e davanti gli sta Apache in ascolto sulla 80 senza alcun host virtuale sulla 443. Il disegno prevedeva un proxy inverso con HTTPS: il proxy c'e', il HTTPS no. Ne discende che il rimedio e' circoscritto e non richiede di rifare l'architettura.

### Un difetto dello strumento, e perche' vale la pena registrarlo

Alla prima esecuzione il censimento falliva sulla VM 204 con un errore di permessi in scrittura, dopo che la password era stata accettata. La causa non era la password ma il parametro di kernel `fs.protected_regular`, che impedisce di aprire in scrittura, dentro una cartella con sticky bit come `/tmp`, un file gia' esistente e di proprieta' di un altro utente, e la restrizione vale anche per l'amministratore. Il file era il residuo di un'esecuzione precedente fatta con un utente diverso. Lo strumento ora lo rimuove prima di riscriverlo e passa la proprieta' all'utente della sessione. Vale la pena registrarlo perche' il messaggio che ne risultava attribuiva il guasto alla password, cioe' indirizzava la diagnosi nel posto sbagliato, che e' esattamente il difetto che #171 prevede per la segmentazione.

### Un host che nessun inventario conteneva
...
## 04/09/2026 - Il triage del delta trova una copia fuori sede scaduta da sei settimane, e un filtro che non l'avrebbe vista

Sessione aperta con il solo riallineamento e con il triage del delta documentale, arretrato di trentadue giorni. Il numero grezzo diceva 453 voci nuove sulla libreria tecnica, e come le due volte precedenti era ingannevole: 830 delle 859 variazioni sono lo spostamento di percorso di un corpus di ricerca gia' escluso dal 15/07/2026. Il nuovo vero era un pugno di file, e la prima cosa da misurare e' stata perche' il delta fosse arretrato: la baseline non era stata riallineata dopo il triage del 06/08, che si era chiuso in attesa di una conferma mai data. Un triage senza il comando che lo accetta non e' finito, e il costo del passo saltato e' un mese di doppioni.

### Il fatto: lo spazio cloud che teneva la seconda copia dei backup e' scaduto il 26/07 e ha una data di cancellazione

Due avvisi del fornitore, entrambi del 25/08/2026 e inoltrati dall'IT Manager nella cartella di scambio con l'annotazione che quello spazio serve alla doppia copia dei backup del NAS-HERO degli ultimi due anni. L'abbonamento da tre terabyte nella regione di Francoforte, attivo dal 19/02/2025, e' scaduto il **26/07/2026**; il periodo di grazia di trenta giorni e' finito il **25/08/2026**; e alla scadenza la capacita' e' tornata a quella del piano gratuito, sedici gigabyte, contro un'occupazione dichiarata di **1,65 terabyte**.

Le conseguenze le enuncia il fornitore e non sarebbero deducibili altrimenti: finche' l'occupazione resta sopra il limite non si depositano file nuovi, non si sincronizza e non si carica nulla tramite gli strumenti di backup ibrido del NAS, e nemmeno si modificano i file gia' presenti; trascorsi sessanta giorni sopra il limite il contenuto viene cancellato fino a rientrare nel piano gratuito. Il campo della data di cancellazione nell'avviso e' vuoto: sessanta giorni dalla fine della grazia cadono nell'ultima decade di ottobre 2026, ed e' un calcolo e non un valore letto.

Restano due domande che questo progetto non risolve e non deve fingere di sapere. Da quando il flusso e' fermo, cioe' se il blocco sia scattato alla scadenza di luglio o alla fine della grazia di agosto, che e' la differenza fra sei settimane e due di copie mancanti. E quale flusso sia fermo: la scheda di continuita' descrive per il NAS-HERO una replica fuori sede verso lo spazio a blocchi di un fornitore diverso, mentre l'annotazione parla dello spazio cloud QNAP, e se siano due percorsi distinti o lo stesso descritto due volte non e' determinato. Dalla risposta dipende se oggi esista ancora una copia fuori sede oppure nessuna.

Tracciato come difetto **#186 (STOR-002)**. Va letto insieme alla riga di `2025-storage-anni-vecchi.md` che dichiara gli anni dal 2023 al 2026 in backup giornaliero verso il NAS INTRA2 con doppia copia sullo spazio cloud, e alla verifica di quella doppia copia elencata fra le sette azioni date per completate nello snapshot del 20/05/2026: erano affermazioni vere che hanno smesso di esserlo il 26/07/2026 senza che nulla le contraddicesse. E' obsolescenza silenziosa, non una contraddizione, ed e' esattamente il rischio che `.claude/rules/fonti-e-riallineamento.md` descrive come proprio di questo progetto.

### Il difetto dello strumento, che vale quanto il fatto

`STATO RETE INTRAWELT.docx`, il documento piu' importante arrivato al progetto in tutto il 2026, **non corrisponde a nessuno dei pattern di rilevanza** dello script del delta: non contiene `network`, non contiene `diagramma di rete`, non nomina un apparato ne' un fornitore. Il 06/08 era stato visto solo perche' cadeva per caso fra le prime venticinque voci in ordine alfabetico di un elenco troncato. E' la stessa famiglia del difetto scoperto il 03/08 sulla cartella esclusa che nel frattempo aveva cambiato uso: non si sbaglia su cio' che si conosce, si sbaglia su cio' che non si e' previsto. Aggiunti alla lista i termini `rete`, `stato rete`, `topologia`, `backup`, `crittograf`, `intervista` e `censimento`. Verificato lo stesso giorno che il documento e' invariato dal 06/08 alle 10:26 e che la sua sezione Piano Terra e' ancora vuota.

### Due allarmi verificati, uno rientrato e uno da porre

Nella cartella del fornitore di rete e' comparso un messaggio intitolato "Your Return" sullo stesso numero d'ordine con cui il 05/08 erano state acquistate le licenze che avevano riacceso la fonte automatica. Se fosse stato un reso di licenze cadrebbe la copertura di ADR-022 e con essa la data che vincola l'organizzazione, quindi la verifica era obbligatoria. Letto: **non e' un reso di licenze**, e' un rimborso d'imposta, seguito del ticket con cui erano stati corretti i dati di fatturazione per ottenere una fattura senza imposta. La copertura regge. La voce resta registrata perche' la prossima persona che legge quel titolo non riapra la domanda da zero.

Il secondo allarme non e' verificabile da qui e diventa una domanda. Nella cartella di scambio, il 01/09, e' comparso un documento che accerta l'impossibilita' di attivare la crittografia del disco su un computer con Windows 11 Home, per due motivi indipendenti, con entrambe le strade percorribili abbandonate. Se quella macchina appartiene al parco gestito e' un difetto di sicurezza dei dati a riposo; se e' una macchina personale non riguarda la rete. Il documento non dice quale sia, e dedurlo sarebbe il sesto episodio della stessa famiglia di errori.

### Un intervento su un apparato di rete che nessuno aveva registrato

Rapporto tecnico del fornitore del multifunzione, intervento in sede del **25/08/2026**: controllo dei collegamenti fra due schede interne e **aggiornamento del firmware**, con prova riuscita. Entra in questa timeline per una ragione sola ma sufficiente. Il multifunzione e' un apparato di rete sulla LAN piatta, con la scansione verso cartella configurata e uno script dedicato in questo repository, e l'aggiornamento del firmware e' il momento tipico in cui le versioni dei protocolli di condivisione accettate, le cifrature ammesse e le impostazioni di destinazione cambiano da sole. La verifica che la scansione verso cartella funzioni ancora **non e' stata fatta** e non viene affermata qui: e' un controllo da mettere in coda.

### Chiuso in giornata, e la meta' che la chiusura non chiude

L'IT Manager ha rinnovato l'abbonamento lo stesso 04/09/2026: licenza acquistata, spazio di nuovo da tre terabyte, regione **Milano** invece di Francoforte, backup dichiarato funzionante. Il difetto #186 si chiude percio' il giorno in cui si apre, e cadono con esso sia il blocco dei caricamenti sia la data di cancellazione di ottobre.

Il cambio di regione non era pero' un dettaglio amministrativo, e la domanda che ne discendeva ha avuto risposta lo stesso giorno: **lo spazio di Milano e' nuovo**, confermato dall'IT Manager. Ne discende che il rinnovo ripristina il backup **corrente** e non la copia fuori sede di cio' che era gia' depositato: il nuovo spazio nasce vuoto, e la storia dichiarata degli ultimi due anni, 1,65 terabyte secondo l'avviso del fornitore, vi tornera' solo a primo caricamento completo.

Quella copia storica non e' sparita, ma nel frattempo vive dove non dovrebbe: sullo spazio di Francoforte, congelato su un abbonamento scaduto e con una cancellazione calcolata intorno al **24/10/2026**. Si apre quindi una finestra in cui la sola copia fuori sede degli anni depositati e' quella con la scadenza addosso, e la finestra si chiude quando il caricamento su Milano finisce, non quando l'abbonamento nuovo viene pagato. E' il difetto **#187**, aperto per questo, e il suo rimedio non e' un acquisto ma una misura: verificare che il job punti al nuovo spazio, leggerne l'avanzamento, stimare la fine e confrontarla con quella data. Va accertato a parte, e non assunto, se dallo spazio scaduto si possa ancora ripristinare oppure soltanto constatare che il contenuto c'e': gli avvisi vietano caricamento, sincronizzazione e modifica, e sul ripristino non dicono nulla.

Resta infine non determinato se questo percorso e la replica verso lo spazio a blocchi descritta nella scheda di continuita' siano **due copie distinte o la stessa descritta due volte**, ed e' la domanda che decide se quella finestra sia scoperta oppure coperta da una seconda copia.

La lezione dell'episodio non scade con il rinnovo. Il fatto non e' arrivato da un apparato ne' da un allarme, ma da una casella di posta triagiata trentadue giorni dopo, e nel frattempo il progetto ha continuato per sei settimane ad affermare che una copia fuori sede esisteva. Il rimedio non e' guardare piu' spesso i backup: e' non lasciare arretrare il triage della classe C, che e' la sola fonte in cui una scadenza amministrativa si vede prima che diventi un guasto.

## 16/09/2026 - Due backup notturni falliscono per attesa scaduta, e sotto c'e' un controller RAID senza cache

Evento notturno sul nodo Proxmox, ricostruito da una sessione di lavoro parallela e consegnato a questo progetto come handoff. Due lavori di backup su otto, quelli della VM 203 e della VM 205, terminano con un errore di attesa scaduta sul lock di vzdump rispettivamente alle 03:30 e alle 04:30, cioe' esattamente centottanta minuti dopo l'orario di ciascuno: centottanta e' il valore predefinito dell'attesa massima, quindi gli orari sono la firma del meccanismo. Su un nodo Proxmox gira un solo backup per volta con un lock globale che vale anche fra destinazioni diverse, quindi gli otto lavori sono una catena seriale in cui il ritardo di uno diventa l'attesa di tutti quelli a valle. Il ritardo viene da un solo guest, la VM 100, passata da sessantaquattro a duecentotrentatre minuti senza che l'archivio prodotto cambi di dimensione. La lettura del registro di avanzamento sposta il problema dal backup allo storage: la velocita' crolla nello stesso identico punto anche nelle notti buone, da circa duecento a una ventina di MiB/s, e in quella rotta a meno di dieci, con il letto sempre pari allo scritto, quindi il limite e' la lettura dal disco sorgente e non la compressione ne' la rete. Il registro del kernel dichiara sul volume logico del controller HPE Smart Array la cache in lettura e in scrittura disabilitata, condizione che su quei controller si presenta da se' quando il modulo di batteria o condensatore che protegge la cache e' guasto o scarico. La causa resta pero' dedotta e non letta, perche' lo strumento del produttore non era installabile in quell'ambiente: e' la ragione per cui la voce nasce aperta come difetto #200 e come domanda datata nel registro delle scadenze, invece che come diagnosi chiusa. Rimedio applicato la mattina stessa e dichiarato come cerotto: attesa massima sul lock portata a ventiquattro ore su tutti e otto i lavori e collisione di orario delle 00:30 rimossa spostando alle 04:30 il secondo backup della VM 100, senza cancellare nessun lavoro, senza cambiare destinazioni e senza toccare la frequenza giornaliera. I backup ora completano e restano lenti, e poiche' la notifica scatta solo sul fallimento il rimedio ha spento anche l'unico segnale che qualcuno riceveva: la riparazione vera e' la sostituzione del modulo di cache, che essendo interno richiede lo spegnimento del nodo e quindi una finestra di manutenzione su tutte le macchine virtuali.
