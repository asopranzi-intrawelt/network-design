...
| 0-9-1 | Derivazione tetto | Fa ponte con 0-8-1. **Non e' un access point**: da qui parte un cavo di categoria 6 verso la centrale di irrigazione, e in mezzo gli elettricisti hanno inserito uno **Zyxel GS-105B v5** per diramare l'access point esterno e l'inverter del fotovoltaico. Correzione del 03/08/2026, vedi sotto. **Aggiornamento del 09/09/2026 (ADR-029)**: il GS-105B viene sostituito da uno switch **gestito e PoE** collegato alla porta 4 del 30HP, con l'access point nuovo appeso a quello in PoE e i tre rami ricablati su di esso; la tratta diventa taggabile e l'apparato diventa inventariato. La velocita' negoziata di 100 Mb/s e' un difetto a se', #196 |
