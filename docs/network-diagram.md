...
INTERNET
   ...
   |   IP pubblico pool: 193.124.241.x/28 (14 IP utilizzabili)
   |
   ...
   │    RemoteAccess IKEv2             pool 192.168.50.0/27           │
   │    SSL VPN 443                    pool 192.168.230.10-250        │
   │                                                                  │
   ...
   Piano 1 (AP 1-8-1, postazioni Potalivo/Martellini/Alessio)
   Piano 2 (AP 2-5-1 CED, AP 2-7-1 tetto esterno)

   Yealink IP phones (Voice VLAN 2, LLDP-MED, CoS 5 / DSCP 46):
     T34W Piano Terra: Potalivo 1-1, Martellini 1-2, Renzi 0-x
     T31G Piano 2:     Marini 2-x, Sala Conero 2-x
...
|------|-----|--------|-------|------|
| Management/Server | 10 | 192.168.10.0/24 | Infrastruttura IT | Switch, AP, server |
| Utenti LAN | 20 | 192.168.20.0/24 | Postazioni, NAS, Proxmox | Default LAN |
| [TBC] | 30 | 192.168.30.0/24 | [TBC] | |
| Guest | 90 | 192.168.90.0/24 | Ospiti, dispositivi IoT | [ANOMALIA: switch mgmt qui] |
...
|----|-------------|-----------|
| 192.168.90.37 | Switch management | CRITICA: management su VLAN guest |
| 192.168.90.33 | UPS Emerson Liebert IntelliSlot | ALTA: gestione UPS esposta |
| 192.168.90.40 | MyHome Server (CentOS 7.6, EOL) | ALTA: OS EOL |
| 192.168.90.41 | Bticino Classe100X citofono | MEDIA: Linux 2.6 EOL |
...
| RemoteAccess_Wiz | IKEv2 | - | 192.168.50.0/27 |
| SSL VPN | HTTPS/443 | - | 192.168.230.10-250 |
...
GroupShare: 10.1.116.3 (WINGROUPSHARE) - raggiungibile via LAN/VPN.

---

## Infrastruttura elettrica

UPS: alimentano server, NAS, centralino. Autonomia 15 min. Modello Emerson Liebert IntelliSlot Web Card (IP 192.168.90.33, porta 6004).
