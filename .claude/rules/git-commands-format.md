...
I comandi git restano sempre manuali dell'utente. Quando l'agente li presenta, li scrive in un blocco PowerShell immediatamente copiabile: una riga per comando, nessun heredoc multi-riga. Standard di sistema: Windows PowerShell 5.1.
