...
| M13c-5 | Verificare la **tratta fisica**: la porta 4 del 30HP negozia a 100 Mbps con PoE attivo, mentre le porte delle postazioni negoziano a 1 Gbps. Va chiarito se il limite e' il vecchio AP (Fast Ethernet per eta') o la tratta stessa (patch nel locale caldaia, cavo verso il tetto con coppie danneggiate): nel secondo caso un AP nuovo resterebbe strozzato e il cavo va sistemato prima. Verifica: sostituire temporaneamente il dispositivo terminale con un portatile e leggere la velocita' negoziata, oppure leggere i contatori di errore della porta | **ALTA — promosso da MEDIA il 03/08/2026** | Snapshot Nebula 27/07/2026 (`linkSpeed AUTO_100M` sulla porta 4) | M13c-1 | **Da fare, e da fare prima dell'ordine.** La promozione ha una ragione precisa: il preventivo del 31/07 propone un apparato con due porte LAN da 1/2,5 Gbps e throughput aggregato dichiarato fino a 11 Gbps. Se il limite a 100 Mbps e' la tratta e non il vecchio apparato, quell'hardware resta strozzato dal cavo e si paga una capacita' inutilizzabile. La verifica costa un portatile e cinque minuti; farla dopo l'ordine significa scoprire il vincolo quando non e' piu' reversibile |
