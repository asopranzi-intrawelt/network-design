...
| M13b | Fase B rete Wi-Fi: pianificare la sostituzione dei tre AP Ubiquiti EOL (non gestibili, credenziali perse, dashboard web mai esistita) con AP Zyxel Nebula multi-SSID, che assorbono anche la copertura guest (DPPSK + VLAN dedicata) invece di affiancare un AP guest isolato ai tre legacy | MEDIA | AP-001 | M13a | Preventivo scelto il 20/07/2026 (Punto Informatica, 3x Zyxel NWA130BE-EU0101 Wi-Fi 7, dettaglio in `runbook-anomalie.md` §AP-001); EsternoIrrigazione fuori scope; **consegna confermata: il 21/07/2026 i tre AP NWA130BE risultano registrati sull'organizzazione Nebula** con i nomi di sito "AP piano terra", "AP Piano 1" e "AP Piano 2", corrispondenti alle tre ubicazioni da sostituire (30HP porta 1, 54HP porte 41 e 45). Resta da fare l'installazione fisica e la configurazione multi-SSID staff/guest, che con la postura decisa in ADR-014 significa un SSID staff sulla VLAN 40 con accesso pieno alla LAN e un SSID ospiti sulla VLAN 90 con SNAT e uscita sola WAN, entrambi gia' funzionanti sull'AP di prova |
...
| Fase 3 | Attiva dal 27/07/2026 — 24 micro-step tracciati; M1 chiuso, M2/M11/M12 parziali, M13a chiuso per decisione (ADR-014), M13b con hardware consegnato e da installare; **M22 promosso a progetto strutturale e prossimo filone di lavoro**; M23/M24 nuovi dalla ricognizione VM | Critica |
